        ...
        <div className="overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-lg">
            ...
            <div className="grid grid-cols-3 gap-3 sm:grid-cols-6">
              {HIGHLIGHTS.map((h) => (
                <div key={h.label} className="flex flex-col items-center gap-1.5">
                  <span className="flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-amber-50 to-amber-100 text-2xl shadow-sm ring-2 ring-amber-200/60">
                    {h.icon}
                  </span>
          ...
          <div className="border-t border-gray-100 px-6 py-6 text-center sm:px-10">
            ...
            >
              ...
              Follow @arbanquets on Instagram
            </a>
          </div>
        </div>
      </div>
